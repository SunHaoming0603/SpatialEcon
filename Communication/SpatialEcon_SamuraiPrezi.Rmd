...
subtitle: "Project 1: Spatial reallocation of areal data"
author: 
- "Siqi Lyu"
- "Amandine SIMO"
- "Lukas Cesare Dargel"
- "Hao Ming Sun"
date: "2019-02-11 (updated: `r Sys.Date()`)"
output:
  xaringan::moon_reader:
    css: [middlebury,middlebury-fonts]
    chakra: SpatialEcon_NinjaPrezi_files/remark-latest.min.js
    nature:
...
It is used to transfer spatial data between diffrent aggregation levels.

```{r eval=TRUE,echo=FALSE, tidy=FALSE}
ggarrange(
ggplot(Census.state49) + 
  geom_sf(fill = NA) + 
  coord_sf(datum = NA) + 
  theme_minimal(),

ggplot(Census.county49) + 
  geom_sf(fill = NA) + 
  coord_sf(datum = NA) + 
  theme_minimal() 
)
